...
def on_request(request: httpx.Request) -> None:
    with tracer.start_as_current_span("request") as req:
        add_raw_request_attributes(request, req)


def on_response(response: httpx.Response) -> None:
    with tracer.start_as_current_span("response") as res:
        add_raw_response_attributes(response, res)


def add_raw_request_attributes(request: httpx.Request, span: trace.Span) -> None:
...
def add_raw_response_attributes(response: httpx.Response, span: trace.Span) -> None:
